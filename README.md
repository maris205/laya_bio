...
**Active route (2026-09-24):** The user paused the direct-SFT/GFP diagnostic route. The active work is fresh biological vocabulary → embedding/MLM-head adaptation → biological CPT → matched no-CPT/CPT single-task SFT using thousands of examples, followed by cumulative multitask evaluation. See the [active plan](refine-logs/EXPERIMENT_PLAN.md) and [pause record](refine-logs/ROUTE_CHANGE_20260924.md). CPT results are not yet available.
