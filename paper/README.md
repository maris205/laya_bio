...
- `main.pdf`: English paper, six-page main body with references and supplementary tables.
- `main.tex`, `sections/`, `references.bib`: editable LaTeX and nine verified references.
...
The Chinese result manuscript is `research/laya_bio_paper_draft.md`.
